...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("src/itheima/java2/doudizhu/image/login/登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("src/itheima/java2/doudizhu/image/login/注册按钮.png"));
        //去除按钮的边框
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("src/itheima/java2/doudizhu/image/login/登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("src/itheima/java2/doudizhu/image/login/注册按下.png"));
        }
    }
